        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(256)", nullable: false),
                    Specialization = table.Column<string>(type: "nvarchar(256)", nullable: false),
                    LicenseNumber = table.Column<string>(type: "nvarchar(256)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InsuranceProvider = table.Column<string>(type: "nvarchar(256)", nullable: false),
                    InsurancePolicyNumber = table.Column<string>(type: "nvarchar(256)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorId = table.Column<int>(type: "int", nullable: false),
                    PatientId = table.Column<int>(type: "int", nullable: false),
                    Medication = table.Column<string>(type: "nvarchar(256)", maxLength: 100, nullable: false),
                    Dosage = table.Column<string>(type: "nvarchar(256)", maxLength: 50, nullable: false),
                    Instructions = table.Column<string>(type: "nvarchar(256)", maxLength: 500, nullable: false),
                    PrescribedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
